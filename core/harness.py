...
class AgentHarness:
    ...
    def evaluate(
        ...
        evaluator = Evaluate(
            devset=dataset, metric=eval_fn, num_threads=num_threads, display_progress=True
        )
...
def train_and_optimize(
    agent_config: NodeConfig, dataset: List[dspy.Example], metric: Optional[Callable] = None
) -> LowCodeAgent:
    """
